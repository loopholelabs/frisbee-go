// Code generated by frisbeegen. DO NOT EDIT.
...
func NewClient(addr string, h PubSubClientHandler, opts ...frisbee.Option) *frisbee.Client {
	return frisbee.NewClient(addr, initPubSubClientRouter(h), opts...)
}
func NewServer(addr string, h PubSubServerHandler, opts ...frisbee.Option) *frisbee.Server {
